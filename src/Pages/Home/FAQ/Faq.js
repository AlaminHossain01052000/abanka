        ...
        <Container>
            <div className='d-flex justify-content-between'>
                <div className='w-100'>
                    ...
                    <div className='d-flex justify-content-between'>
                        <div className='d-flex justify-content-center faq-contact-container align-items-center'>
                            <i class="fas fa-phone me-4"></i>
                            <p>+880-0181351111</p>
                        </div>
                        <div className='d-flex justify-content-between faq-contact-container align-items-center'>
